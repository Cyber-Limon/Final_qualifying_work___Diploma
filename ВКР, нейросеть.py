...
for material_property in range(len(properties[0])):
    ...
    X_train_current, y_train_current = augmentation(X_train_current, y_train_current, 800)
    X_test_current, y_test_current   = augmentation(X_test_current, y_test_current, 200)
